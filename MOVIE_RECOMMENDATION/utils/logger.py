...
class Logger:
    ...
    def log_recommendation(self, user_id: int, algorithm: str, 
    ...
    def log_llm_query(self, model: str, query: str, response_time: float, 
    ...
    def log_model_performance(self, metric: str, value: float, 
                            algorithm: str = "svd"):
