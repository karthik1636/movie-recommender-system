...
class TestMovieRecommenderAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_recommender.get_recommendations.return_value = [
            {'movieId': 1, 'title': 'Test Movie 1', 'genres': 'Action', 'similarity_score': 0.8}
        ]
        
        # Mock the get_similar_movies method
        self.mock_recommender.get_similar_movies.return_value = [
            {'movieId': 2, 'title': 'Test Movie 2', 'genres': 'Comedy', 'similarity_score': 0.7}
        ]
    ...
    def test_ask_llm_invalid_model(self):
        ...
        result = api.ask_llm('action movies', model='invalid-model', n_recommendations=5)
...
class TestMovieDatabase(unittest.TestCase):
    ...
    def test_create_user_duplicate(self):
        ...
        result = self.db.create_user('testuser', 'test2@example.com', 'hashed_password2')
